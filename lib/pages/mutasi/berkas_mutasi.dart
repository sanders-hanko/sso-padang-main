...
import 'form_mutasi.dart';

class BerkasMutasi extends StatefulWidget {
  const BerkasMutasi({
    super.key,
  ...
  @override
  State<BerkasMutasi> createState() => StateBerkasMutasi();
}

class StateBerkasMutasi extends State<BerkasMutasi> {
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              'Berikut persyaratan berkas untuk pengajuan $namaLayanan:',
                              textAlign: TextAlign.justify,
                            ),
                          ),
                          Column(
                            ...
                            await Navigator.of(context).push(
                              CupertinoPageRoute(
                                builder: (context) {
                                  return FormMutasi(
                                    files: snapshot.data,
                                    namaLayanan: namaLayanan, idJenisLayanan: idLayanan,
                                  );
                                },
                              ),
                            );
