...
import 'package:super_app/pages/mutasi/detail_mutasi.dart';
...
class ListMutasi extends StatefulWidget {
  ...
  @override
  State<ListMutasi> createState() => StateListMutasi();
}

class StateListMutasi extends State<ListMutasi> {
  ...
  Future<List> getData() async {
    ...
    kodeLayanan = utility.kodeLayananMutasi;
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Text(
                            'lihat detail permohonan Mutasi',
                            style: TextStyle(
