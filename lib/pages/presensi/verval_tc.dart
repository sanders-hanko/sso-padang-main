...
class VervalTc extends StatefulWidget {
  const VervalTc({super.key});

  @override
  State<VervalTc> createState() => StateVervalTc();
}

class StateVervalTc extends State<VervalTc> {
          ...
          children: [
            ...
            Expanded(
              child: SizedBox(
                ...
                width: MediaQuery.of(context).size.width,
                child: FutureBuilder(
                  future: _service.getIzinAbsensiBawahan(status),
                  builder: (context, snapshot) {
                    ...
                    for (var element in snapshot.data!) {
                      ...
                      final String unencodedPath =
                          '${utils.fotoIzinAbsensi}${element['nip']}/${element['log_absensi_id']}/${element['file']}';
                              ...
                              var status = await Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (builder) => VervalDetail(
                                    url: url.toString(),
                                    heroTag: 'hero${element['id']}',
                                    nama: '${element['nama']}',
                                    nip: '${element['nip']}',
                                    jenisIzin: '${element['jenis_izin']}',
                                    alasan: '${element['alasan']}',
                                    tanggal: tanggal,
                                    id: '${element['id']}',
