...
class VerifikatorMenunggu extends StatefulWidget {
  const VerifikatorMenunggu({
    super.key,
  ...
  @override
  State<VerifikatorMenunggu> createState() => StateVerifikatorMenunggu();
}

class StateVerifikatorMenunggu extends State<VerifikatorMenunggu> {
  ...
  Future<List> getData() async {
    ...
    final data = await service.getListTransVerifikator(kodeLayanan, nip, '0');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CupertinoNavigationBar(
        ...
        middle: Text('Menunggu Verifikasi'),
      ),
      body: SafeArea(
        bottom: false,
        child: FutureBuilder(
