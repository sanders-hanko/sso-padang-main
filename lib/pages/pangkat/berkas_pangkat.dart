...
class BerkasPangkat extends StatefulWidget {
  const BerkasPangkat({
    super.key,
  ...
  @override
  State<BerkasPangkat> createState() => StateBerkasPangkat();
}

class StateBerkasPangkat extends State<BerkasPangkat> {
                  ...
                  child: ListView(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          "Persyaratan berkas untuk pengajuan Kenaikan Pangkat Jabatan $namaLayanan belum tersedia. "
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              'Berikut persyaratan berkas untuk pengajuan Kenaikan Pangkat Jabatan $namaLayanan:',
                              textAlign: TextAlign.justify,
                            ),
                          ),
                          Column(
