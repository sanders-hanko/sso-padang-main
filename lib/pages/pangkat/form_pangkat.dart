...
class FormPangkat extends StatefulWidget {
  const FormPangkat({
    super.key,
    required this.files,
  ...
  @override
  State<FormPangkat> createState() => StateFormPangkat();
}

class StateFormPangkat extends State<FormPangkat> {
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Pengajuan Kenaikan Pangkat Jabatan ${widget.namaLayanan}.',
