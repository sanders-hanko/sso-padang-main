...
class PilihJenisPangkat extends StatefulWidget {
  const PilihJenisPangkat({super.key});

  @override
  State<PilihJenisPangkat> createState() => StatePilihJenisPangkat();
}

class StatePilihJenisPangkat extends State<PilihJenisPangkat> {
  final getJenisLayanan = BerkasService().getJenisLayanan(Utils().kodeLayananPangkat);
                  ...
                  children: [
                    Container(
                      ...
                      child: CupertinoListTile(
                        title: const Text('Jenis Pengajuan Pangkat'),
