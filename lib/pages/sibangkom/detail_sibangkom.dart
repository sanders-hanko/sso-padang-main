...
class DetailSibangkom extends StatefulWidget {
  const DetailSibangkom({
    super.key,
  ...
  @override
  State<DetailSibangkom> createState() => StateDetailSibangkom();
}

class StateDetailSibangkom extends State<DetailSibangkom> {
          ...
          builder: (context, snapshot) {
            ...
            snapshot.data?.forEach(
              (val) {
                ...
                final Widget statusHeader = val['is_inprogress'] == false
                    ? Container(
