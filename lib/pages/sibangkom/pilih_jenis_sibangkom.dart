...
class PilihJenisSibangkom extends StatefulWidget {
  const PilihJenisSibangkom({super.key});

  @override
  State<PilihJenisSibangkom> createState() => StatePilihJenisSibangkom();
}

class StatePilihJenisSibangkom extends State<PilihJenisSibangkom> {
  final getJenisLayanan = BerkasService().getJenisLayanan(Utils().kodeLayananSibangkom);
                    ...
                    children: [
                      Container(
                        ...
                        child: CupertinoListTile(
                          title: const Text('Jenis Pengembangan Kompetensi'),
